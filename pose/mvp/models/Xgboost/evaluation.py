...
def xgb_inference(best_weights, eval_dir, scaler):
...
def xgboost_main(
    ...
    results, true_labels, all_preds = xgb_inference(best_weights, eval_dir, scaler)
    ...
    report_csv_path = WEIGHTS / "Xgboost_classification_report.csv"
